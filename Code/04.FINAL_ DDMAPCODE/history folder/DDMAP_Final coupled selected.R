...
#    M1_DEP$Eucl_dist<-sqrt((1/4)*(M1_DEP$Hydrology)^2+(3/4)*(M1_DEP$Climatology)^2)
    ...
    G4<-levelplot(t(M_grid3_DEP), col.regions = coul,cex.main=0.05 ,
                  xlab="Kendall's Tau",ylab="Hydrological Index",at=c(seq(0,1,0.5)), 
    ...
    ggsave("C:/Users/39349/Documents/Regional/Plot/OnWorking/07.DDMAP_LEGEND.jpeg", units="in", dpi=400, width=7.28,height=7.76)
    ...
    png("C:/Users/39349/Documents/Regional/Plot/OnWorking/06.BOXPLOT_6.jpeg", units="in", res=400, height=6.28,width =8.7)
    ...
    png("C:/Users/39349/Documents/Regional/Plot/OnWorking/05.BOXPLOT_3.jpeg", units="in", res=400, height=6.28,width =8.7)
    
    par(mfrow=c(1,3))
    
    boxplot(M1_DEP$Meteo,M1_IND$Meteo
            ,names=c("Dependent","Independent"), main="a) Asynchrony",ylim=c(0,1),outline=FALSE, ylab="Index", cex.main=1.5, 
            cex.lab=1.5 ,cex.axis=1.3,col=c("#33CCCC","#FF3333"))
