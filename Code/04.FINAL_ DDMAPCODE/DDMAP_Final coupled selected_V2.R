...
#hh<-4
  ...
  #ff<-24
    ...
    Final_D<-c("Maximum.altitude","Arable.horticultural", "Mountain.heath.bog","BFIHOST....", "PROPWET")
    ...
    title=print(paste0("Hydrological Indexes selected: ",colnames(M_ALL_0.01_POS_perc[,c(50, Final_D)])))
...
#    M1_DEP$Eucl_dist<-sqrt((1/4)*(M1_DEP$Hydrology)^2+(3/4)*(M1_DEP$Climatology)^2)
    ...
    #easy way
    G1<-grid.arrange(P1_DEP, P1_IND, P2_DEP, P2_IND, P3_DEP, P3_IND,nrow=4,ncol=2,legend = "bottom",common.legend = TRUE)
    ...
    ggsave("C:/Users/39349/Documents/Regional/Plot/OnWorking/07.DDMAP1.jpeg",G1, units="in", dpi=400, width=10.28,height=16.76)
    ...
    ggsave("C:/Users/39349/Documents/Regional/Plot/OnWorking/07.DDMAP_LEGEND.jpeg",fg, units="in", dpi=400, width=10.28,height=16.76)
