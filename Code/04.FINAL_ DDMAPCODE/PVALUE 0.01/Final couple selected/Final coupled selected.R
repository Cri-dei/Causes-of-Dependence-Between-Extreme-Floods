...
## DEPENDENT COUPLES
M1_DEP_0<-M_ALL_0.01_POS_perc[,c(15,57,69,4,68,18,25,17,13,11,12)]

colnames(M1_DEP_0)<-c("Meteo","Hydrology","Climatology","KendallTau","Class","X.1","Distance","Asypvalue","Num Syn","Station1","Station2")


## DEPENDENT COUPLES
M1_IND_0<-M_ALL_IND_perc0.01[,c(15,57,69,4,68,18,25,17,13,11,12)]
...
pdf(file=paste0("GROUP_ALL_3dPLOT_pv",pvalue,"_",vv,".pdf"),width=9, height=9)  
xxx<-1
...
#    M1_DEP$Eucl_dist<-sqrt((1/4)*(M1_DEP$Hydrology)^2+(3/4)*(M1_DEP$Climatology)^2)
    ...
    P1_DEP<-levelplot(t(M_grid1_DEP), col.regions = coul, cex.main=0.05, 
                      xlab=expression('I '[M]),ylab=expression('I '[H]),
                      at=c(seq(-1,1,0.05)), scales=list( y=list(rot=0), x=list(rot=45)),colorkey=FALSE )
    #colorkey=FALSE , 
    P2_DEP<-levelplot(t(M_grid2_DEP), col.regions = coul,cex.main=0.05, 
                      xlab=expression('I '[M]),ylab=expression('I '[C]),
                      at=c(seq(-1,1,0.05)), scales=list( y=list(rot=0), x=list(rot=45)),colorkey=FALSE ) 
    ...
    P3_IND<-levelplot(t(M_grid3_IND), col.regions = coul, main=" ",cex.main=0.05, 
                      xlab=expression('I '[C]),ylab=expression('I '[H]),at=c(seq(-1,1,0.05)), scales=list( y=list(rot=0), x=list(rot=45)),
                      colorkey=FALSE )
    
    
    G1<-grid.arrange(P1_DEP, P1_IND, P2_DEP, P2_IND, P3_DEP, P3_IND,nrow=3,ncol=2, 
                     labels=c("a)","b)","c)","d)","f)","g)"),top = textGrob("DEPENDENT                                                                     INDEPENDENT",gp=gpar(fontsize=18,font=3)), heights=c(0.3,0.3,0.3) )
    
    ggsave("DDMAP_DEP_IND_4_24_INDEX2.pdf",G1, width = 29, height = 34, units = "cm")
    ...
    G4<-levelplot(t(M_grid3_DEP), col.regions = coul,cex.main=0.05 ,
                  xlab="Kendall's Tau",ylab="Hydrological Index", cuts=2,at=c(seq(-1,1,0.1)), 
                  scales=list( y=list(rot=0), x=list(rot=45)),colorkey=list(space="bottom",tick.number=20),
                  par.settings = list(layout.heights=list(xlab.key.padding=1)))
    
    fg<-ggarrange(G4,nrow=1)
    ggsave("LEGEND_4_24.pdf",fg, width = 20, height = 36, units = "cm")
    ...
    P4_DEP<-levelplot(t(M_grid4_DEP), col.regions = coul, main="DEPENDENT", 
                      xlab=expression('I '[C]),ylab=expression('I '[H]),at=c(seq(0,1,0.05)), 
    ...
    boxplot(M1_DEP$Meteo[M1_DEP$Class=="Depdep"],M1_DEP$Meteo[M1_DEP$Class=="Depind"],M1_DEP$Meteo[M1_DEP$Class=="High Syn"]
            ,names=c("Dep-Dep","Dep-Ind","High Syn"), main="Asynchrony",ylim=c(0,1),outline=FALSE, cex.main=1.5,cex.axis=1.3,ylab="Dissimilarity Index")
    ...
    boxplot(M1_DEP$Climatology[M1_DEP$Class=="Depdep"],M1_DEP$Climatology[M1_DEP$Class=="Depind"],M1_DEP$Climatology[M1_DEP$Class=="High Syn"]
            ,names=c("Dep-Dep","Dep-Ind","High Syn"), main="Climatology",ylim=c(0,1),outline=FALSE, cex.main=1.5,cex.axis=1.3)
  
    boxplot(M1_DEP$Hydrology[M1_DEP$Class=="Depdep"],M1_DEP$Hydrology[M1_DEP$Class=="Depind"],M1_DEP$Hydrology[M1_DEP$Class=="High Syn"]
            ,names=c("Dep-Dep","Dep-Ind","High Syn"), main="Hydrology",ylim=c(0,1),outline=FALSE, cex.main=1.5,cex.axis=1.3)
    ...
    boxplot(M1_DEP$Distance[which(M1_DEP$Class=="Depdep")],M1_DEP$Distance[which(M1_DEP$Class=="Depind")],M1_DEP$Distance[which(M1_DEP$Class=="High Syn")],
            names=c("Dep-Dep","Dep-Ind","High Syn"), main="Distance",outline=FALSE, cex.main=1.5,cex.axis=1.3)
    ...
    boxplot(M1_DEP$KendallTau[M1_DEP$Class=="Depdep"],M1_DEP$KendallTau[M1_DEP$Class=="Depind"],M1_DEP$KendallTau[M1_DEP$Class=="High Syn"]
            ,names=c("Dep-Dep","Dep-Ind","High Syn"), main="Kendall's Tau",ylim=c(0,1),outline=FALSE, cex.main=1.5,cex.axis=1.3)
    ...
    boxplot(M1_DEP$Meteo,M1_IND$Meteo
            ,names=c("Dependent","Independent"), main="Asynchrony",ylim=c(0,1),outline=FALSE, ylab="Dissimilarity Index", cex.main=1.5, 
            cex.lab=1 ,cex.axis=1.3)
    
    boxplot(M1_DEP$Climatology,M1_IND$Climatology
            ,names=c("Dependent","Independent"), main="Climatology",ylim=c(0,1),outline=FALSE,ylab="Dissimilarity Index", cex.main=1.5, 
            cex.lab=1,cex.axis=1.3)
    
    boxplot(M1_DEP$Hydrology,M1_IND$Hydrology
            ,names=c("Dependent","Independent"), main="Hydrology",ylim=c(0,1),outline=FALSE,ylab="Dissimilarity Index", cex.main=1.5, 
            cex.lab=1,cex.axis=1.3)
