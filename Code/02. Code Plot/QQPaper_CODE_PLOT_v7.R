...
plot(M_ALL[,4], M_ALL[,5], xlab=c("Kendall's tau"), ylab=c("p-value"), col=M_ALL_0.01$Distance, cex.lab=1.2, cex.axis=1.2,  cex.sub=1.2) 
abline(h =0.01, untf = FALSE, col="red",lty = "dashed",lwd=2) 

par(new=TRUE, oma=c(12,2,1,1))
layout(matrix(1:2,1))
plot(M_ALL_0.01[,4], M_ALL_0.01[,5], xlab=c("Kendall's tau"), ylab=c("p-value"), col=M_ALL_0.01$Distance) 
abline(h =0.01, untf = FALSE, col="red",lty = "dashed",lwd=2) 
...
ggplot(data=M_ALL_0.01,aes(x=M_ALL_0.01[,4], y=M_ALL_0.01[,5]))+
  geom_point(aes(color =Distance),size = 2)+ scale_color_gradientn(colours = rainbow(8))+
  xlab("Kendall's Tau")+ ylab("p-value")


main.plot<-ggplot(data=M_ALL, aes(x=M_ALL[,4], y=M_ALL[,5]))+
...
inset.plot <- ggplot(data=M_ALL_0.01,aes(x=M_ALL_0.01[,4], y=M_ALL_0.01[,5]))+
...
Plot_KT<-"C:/Users/39349/Documents/Regional/Plot/01-KT_pval_distance.jpeg"
...
#  geom_histogram(aes(y=6*..density..),
#                 alpha=0.5,position='identity',binwidth=6) + theme_bw()+ 
#  scale_fill_manual(values=cols)+ labs(x = "Distance [km]", y="Density")+
#  theme(legend.position = c(0.8, 0.5))

GG_3<-ggplot(data=M_ALL, aes(x=M_ALL[,25], group=XG, fill=XG ))+
  geom_histogram(aes(y=6*..density..),
                 alpha=0.5,position='identity',binwidth=6) + theme_bw()+ 
...
#GG_4old<-ggplot(data=M_ALL ,aes(x=M_ALL[,4],y= M_ALL[,15],color = as.factor(X)))+geom_point(alpha = 0.3, size=0.9) + theme_bw()+ 
...
GG_4<-ggplot(data=M_ALL ,aes(x=M_ALL[,4],y= M_ALL[,15], color=as.factor(X)))+geom_point(alpha = alpha1, size=size1,aes(shape=as.factor(X))) + theme_bw()+ 
  scale_colour_manual(values=c("#FF3333", "#33CCCC"))+ labs(x = "Kendall's tau", y="Syn")+  
  theme(legend.position = "none")+  
  scale_shape_manual(values =c(16,17))

GG_5<-ggplot(data=M_ALL ,aes(x=M_ALL[,25],y= M_ALL[,15], color=as.factor(X)))+geom_point(alpha = alpha1, size=size1,aes(shape=as.factor(X), color=as.factor(X))) + theme_bw()+ 
  scale_colour_manual(values=c("#FF3333", "#33CCCC"))+ labs(x = "Distance [km]", y="Syn")+  
  theme(legend.position = "none")+  
  scale_shape_manual(values = c(16,17))


GG_6<-ggplot(data=M_ALL ,aes(x=M_ALL[,25],y= M_ALL[,4], color=as.factor(X)))+geom_point(aes(shape=as.factor(X)),alpha = alpha1, size=size1) + theme_bw()+ 
  scale_colour_manual(values=c("#FF3333", "#33CCCC"))+ labs(x = "Distance [km]", y="Kendall's tau")+  
  theme(legend.position = "none")+  
  scale_shape_manual(values = c(16,17))
...
GG_5old<-ggplot(data=M_ALL ,aes(x=M_ALL[,25],y= M_ALL[,15],color = as.factor(X)))+geom_point(alpha = 0.3, size=0.9) + theme_bw()+ 
...
GG_55<-GG_5 + scale_x_continuous(
  labels = scales::number_format(accuracy = 0.01,
                                 decimal.mark = '.'), breaks = c(0,0.25,0.50,0.75,1))

GG_6old<-ggplot(data=M_ALL ,aes(x=M_ALL[,25],y= M_ALL[,4],color = as.factor(X)))+geom_point(alpha = 0.3, size=0.9) + theme_bw()+ 
...
GG_update<-ggarrange(GG_11,GG_22,GG_3,GG_44,GG_5,GG_6,ncol=3,nrow=2, labels=c("a)","b)","c)","d)","e)","f)") ,font.label = list(size = 12)) 

ggsave("C:/Users/39349/Documents/Regional/Plot/OnWorking/02.Correlogram_wlg.jpeg", units="in",dpi=400, height=7,width =10.33)
...
setwd("C:/Users/39349/Documents/Regional/Plot/OnWorking")
...
#plot(M_ALL_0.01$Distance, M_ALL_0.01$KendalT.value,col='cyan3',xlab='Distance [km]',ylab="Kendall's tau",pch=16, cex.lab=1.2, cex.axis=1.2,  cex.sub=1.2, ylim=c(0,1))
par(mfrow=c(1,1))

xx = c(220,220,240,240)
yy = c(-1,1.5,1.5,-1)

plot(M_ALL_0.01$Distance[M_ALL_0.01$Distance<230], M_ALL_0.01$KendalT.value[M_ALL_0.01$Distance<230],col=rgb(0,0,1,1/4),xlab='Distance [km]',
                                                ylab="Kendall's tau",pch=19, cex.lab=1.2, cex.axis=1.2,  cex.sub=1.2, ylim=c(0,1), xlim=c(0,600))

points(M_ALL_0.01$Distance[M_ALL_0.01$Distance>=230], M_ALL_0.01$KendalT.value[M_ALL_0.01$Distance>=230],col=rgb(1,0,0,1/4),xlab='Distance [km]',
...
KT_distance<-"C:/Users/39349/Documents/Regional/Plot/OnWorking/03_KTHIST-1.png"
Histogram<-"C:/Users/39349/Documents/Regional/Plot/OnWorking/03_KTHIST-2.png"
...
ggsave("C:/Users/39349/Documents/Regional/Plot/OnWorking/02.KT-HIST.jpeg", units="in", dpi=400, width=7.28,height=7.76)
