...
######REVISED CODE AFTER 1 REVISION: OCTOBER 2020#################
#################################################################
...
Plot_KT<-"C:/Users/39349/Documents/Regional/Plot/OnWorking/01-KT_pval_distance.png"
...
ggsave("C:/Users/39349/Documents/Regional/Plot/OnWorking/02.Correlogram_wleg.jpeg", units="in",dpi=400, height=7,width =12)
...
GG_4v2<-ggplot(data=M_ALL ,aes(x=M_ALL[,4],y= M_ALL[,15],color = as.factor(X)))+geom_point(aes(shape=as.factor(X)),alpha = 0.3, size=0.9) + theme_bw()+ 
  scale_fill_manual(values=c("#FF3333", "#33CCCC"))+ labs(x = "Kendall's tau", y="Syn")+
...
GG_5v2<-ggplot(data=M_ALL ,aes(x=M_ALL[,25],y= M_ALL[,15],color = as.factor(X)))+geom_point(aes(shape=as.factor(X)),alpha = 0.3, size=0.9) + theme_bw()+ 
  scale_fill_manual(values=c("#FF3333", "#33CCCC"))+ labs(x = "Distance [km]", y="Syn") + 
  theme(legend.position = "none")


GG_6v2<-ggplot(data=M_ALL ,aes(x=M_ALL[,25],y= M_ALL[,4],color = as.factor(X)))+geom_point(aes(shape=as.factor(X)),alpha = 0.3, size=0.9) + theme_bw()+ 
  scale_fill_manual(values=c("#FF3333", "#33CCCC"))+ labs(x = "Distance [km]", y="Kendall's tau")+ 
  theme(legend.position = "none")
...
ggsave("C:/Users/39349/Documents/Regional/Plot/OnWorking/02.Correlogram_wlg_v2.jpeg", units="in",dpi=400, height=7,width =12)
...
GG_4v2<-ggplot(data=M_ALL ,aes(x=M_ALL[,4],y= M_ALL[,15],color = as.factor(X)))+geom_point(aes(shape=as.factor(X),size=as.factor(X)),alpha = 0.3) + theme_bw()+ 
  scale_fill_manual(values=c("#FF3333", "#33CCCC"))+ labs(x = "Kendall's tau", y="Syn")+
...
GG_5v2<-ggplot(data=M_ALL ,aes(x=M_ALL[,25],y= M_ALL[,15],color = as.factor(X)))+geom_point(aes(shape=as.factor(X),size=as.factor(X)),alpha = 0.3) + theme_bw()+ 
  scale_fill_manual(values=c("#FF3333", "#33CCCC"))+ labs(x = "Distance [km]", y="Syn") + 
  scale_size_manual(values=size_val)+
  scale_shape_manual(values=shape_val)+
  theme(legend.position = "none")
...
GG_6v2<-ggplot(data=M_ALL ,aes(x=M_ALL[,25],y= M_ALL[,4],color = as.factor(X)))+geom_point(aes(shape=as.factor(X),size=as.factor(X)),alpha = 0.3) + theme_bw()+ 
  scale_fill_manual(values=c("#FF3333", "#33CCCC"))+ labs(x = "Distance [km]", y="Kendall's tau")+ 
  scale_size_manual(values=size_val)+
  scale_shape_manual(values=shape_val)+
  theme(legend.position = "none")
...
ggsave("C:/Users/39349/Documents/Regional/Plot/OnWorking/02.Correlogram_wlg_v3.jpeg", units="in",dpi=400, height=7,width =12)
...
ggsave("C:/Users/39349/Documents/Regional/Plot/OnWorking/02.KT-HIST1.jpeg", units="in", dpi=400, width=7.28,height=7.76)
